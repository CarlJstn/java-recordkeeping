...
public class Cohabitation extends javax.swing.JFrame {
    ...
    String name =  Variables.Fullname.get(searchIndex) , address = "" ,father="",mother="",stat="",gender="";
    String bday = "";
    int age;
...
//        age = currentD - bdayD;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(265, 170, 90, 40));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(165, 170, 90, 40));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       {
        try {
                FileOutputStream outStream = new FileOutputStream(home.getAbsolutePath() + "\\cohabitation.docx");
...
//            doc.addPictureData(picbytes, Document.PICTURE_TYPE_PNG);
            ...
            try {
                File f = new File(DIR + "\\cohabitation.docx");
